...
--
-- Host: office-web1.promage-server.ch
-- Generation Time: Jan 12, 2015 at 06:09 AM
...
CREATE TABLE IF NOT EXISTS `com_vtiger_workflows` (
  ...
  `module_name` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `summary` varchar(400) COLLATE utf8_bin NOT NULL,
  ...
  `schdayofmonth` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `schdayofweek` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `schannualdates` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `schtime` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `com_vtiger_workflowtasks_entitymethod` (
  ...
  `module_name` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `method_name` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `function_path` varchar(400) COLLATE utf8_bin DEFAULT NULL,
  `function_name` varchar(100) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `com_vtiger_workflowtask_queue` (
  ...
  `entity_id` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `do_after` int(11) DEFAULT NULL,
  `task_contents` text COLLATE utf8_bin
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `com_vtiger_workflowtemplates` (
  ...
  `template` text COLLATE utf8_bin,
...
CREATE TABLE IF NOT EXISTS `com_vtiger_workflow_tasktypes` (
  `id` int(11) NOT NULL,
  `tasktypename` varchar(255) COLLATE utf8_bin NOT NULL,
  `label` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `classname` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `classpath` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `templatepath` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `modules` varchar(500) COLLATE utf8_bin DEFAULT NULL,
  `sourcemodule` varchar(255) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_account` (
  ...
  `account_no` varchar(100) COLLATE utf8_bin NOT NULL,
  `accountname` varchar(100) COLLATE utf8_bin NOT NULL,
  `parentid` int(19) DEFAULT '0',
  `account_type` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `industry` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `annualrevenue` decimal(25,8) DEFAULT NULL,
  `rating` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `ownership` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `siccode` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `tickersymbol` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `phone` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `otherphone` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `email1` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  ...
  `emailoptout` varchar(3) COLLATE utf8_bin DEFAULT '0',
  `notify_owner` varchar(3) COLLATE utf8_bin DEFAULT '0',
  `isconvertedfromlead` varchar(3) COLLATE utf8_bin DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `vtiger_accountbillads` (
  ...
  `bill_city` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `bill_code` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `bill_country` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `bill_state` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `bill_street` varchar(250) COLLATE utf8_bin DEFAULT NULL,
  `bill_pobox` varchar(30) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_accountrating` (
  ...
  `rating` varchar(200) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_accountshipads` (
  `accountaddressid` int(19) NOT NULL DEFAULT '0',
  `ship_city` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `ship_code` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `ship_country` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `ship_state` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `ship_pobox` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `ship_street` varchar(250) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`accountaddressid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_accounttype` (
  ...
  `accounttype` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `vtiger_actionmapping` (
  ...
  `actionname` varchar(200) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_activity` (
  ...
  `semodule` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `activitytype` varchar(200) COLLATE utf8_bin NOT NULL,
  `date_start` date NOT NULL,
  `due_date` date DEFAULT NULL,
  `time_start` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `time_end` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `sendnotification` varchar(3) COLLATE utf8_bin NOT NULL DEFAULT '0',
  `duration_hours` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `duration_minutes` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `status` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `eventstatus` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `priority` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `location` varchar(150) COLLATE utf8_bin DEFAULT NULL,
  `notime` varchar(3) COLLATE utf8_bin NOT NULL DEFAULT '0',
  `visibility` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT 'all',
  `recurringtype` varchar(200) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_activity_reminder_popup` (
  ...
  `semodule` varchar(100) COLLATE utf8_bin NOT NULL,
  `recordid` int(19) NOT NULL,
  `date_start` date NOT NULL,
  `time_start` varchar(100) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_activity_view` (
  ...
  `activity_view` varchar(200) COLLATE utf8_bin NOT NULL,
  `sortorderid` int(19) NOT NULL DEFAULT '0',
  `presence` int(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `vtiger_announcement` (
  ...
  `announcement` text COLLATE utf8_bin,
...
(1, 'In Service', 1, 286, 1),
(2, 'Out-of-service', 1, 287, 2);
...
CREATE TABLE IF NOT EXISTS `vtiger_asterisk` (
  `server` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `port` varchar(30) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_asteriskextensions` (
  ...
  `asterisk_extension` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `use_asterisk` varchar(3) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_asteriskincomingcalls` (
  `from_number` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `from_name` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `to_number` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `callertype` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `flag` int(19) DEFAULT NULL,
  `timer` int(19) DEFAULT NULL,
  `refuid` varchar(255) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_asteriskincomingevents` (
  ...
  `callertype` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `timer` int(20) DEFAULT NULL,
  `flag` varchar(3) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_attachmentsfolder` (
  ...
  `foldername` varchar(200) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_blocks` (
  ...
  `blocklabel` varchar(100) COLLATE utf8_bin NOT NULL,
...
(95, 40, 'LBL_MODCOMMENTS_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(96, 40, 'LBL_OTHER_INFORMATION', 2, 0, 0, 0, 0, 0, 1, 0),
(97, 40, 'LBL_CUSTOM_INFORMATION', 3, 0, 0, 0, 0, 0, 1, 0),
(98, 43, 'LBL_PROJECT_MILESTONE_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(99, 43, 'LBL_CUSTOM_INFORMATION', 2, 0, 0, 0, 0, 0, 1, 0),
(100, 43, 'LBL_DESCRIPTION_INFORMATION', 3, 0, 0, 0, 0, 0, 1, 0),
(101, 44, 'LBL_PROJECT_TASK_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(102, 44, 'LBL_CUSTOM_INFORMATION', 2, 0, 0, 0, 0, 0, 1, 0),
(103, 44, 'LBL_DESCRIPTION_INFORMATION', 3, 0, 0, 0, 0, 0, 1, 0),
(104, 45, 'LBL_PROJECT_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
...
(110, 48, 'LBL_ASSET_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(111, 48, 'LBL_CUSTOM_INFORMATION', 2, 0, 0, 0, 0, 0, 1, 0),
(112, 48, 'LBL_DESCRIPTION_INFORMATION', 3, 0, 0, 0, 0, 0, 1, 0),
...
CREATE TABLE IF NOT EXISTS `vtiger_calendar_default_activitytypes` (
  ...
  `defaultcolor` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_campaign` (
  `campaign_no` varchar(100) COLLATE utf8_bin NOT NULL,
  `campaignname` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `campaigntype` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `campaignstatus` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `expectedrevenue` decimal(25,8) DEFAULT NULL,
  `budgetcost` decimal(25,8) DEFAULT NULL,
  `actualcost` decimal(25,8) DEFAULT NULL,
  `expectedresponse` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `numsent` decimal(11,0) DEFAULT NULL,
  `product_id` int(19) DEFAULT NULL,
  `sponsor` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `targetaudience` varchar(255) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_campaignrelstatus` (
  `campaignrelstatusid` int(19) DEFAULT NULL,
  `campaignrelstatus` varchar(256) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_campaignstatus` (
  ...
  `campaignstatus` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_campaigntype` (
  ...
  `campaigntype` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_carrier` (
  ...
  `carrier` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_contactaddress` (
  ...
  `mailingcity` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `mailingstreet` varchar(250) COLLATE utf8_bin DEFAULT NULL,
  `mailingcountry` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `othercountry` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `mailingstate` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `mailingpobox` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `othercity` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `otherstate` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `mailingzip` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `otherzip` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `otherstreet` varchar(250) COLLATE utf8_bin DEFAULT NULL,
  `otherpobox` varchar(30) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_contactdetails` (
  `contactid` int(19) NOT NULL DEFAULT '0',
  `contact_no` varchar(100) COLLATE utf8_bin NOT NULL,
  `accountid` int(19) DEFAULT NULL,
  `salutation` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  ...
  `reportsto` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `training` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `usertype` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `contacttype` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `otheremail` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `secondaryemail` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `donotcall` varchar(3) COLLATE utf8_bin DEFAULT NULL,
  `emailoptout` varchar(3) COLLATE utf8_bin DEFAULT '0',
  `imagename` varchar(150) COLLATE utf8_bin DEFAULT NULL,
  `reference` varchar(3) COLLATE utf8_bin DEFAULT NULL,
  `notify_owner` varchar(3) COLLATE utf8_bin DEFAULT '0',
  `isconvertedfromlead` varchar(3) COLLATE utf8_bin DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `vtiger_contactsubdetails` (
  ...
  `homephone` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `otherphone` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `assistant` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `assistantphone` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `birthday` date DEFAULT NULL,
  `laststayintouchrequest` int(30) DEFAULT '0',
  `laststayintouchsavedate` int(19) DEFAULT '0',
  `leadsource` varchar(200) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_crmentity` (
  ...
  `setype` varchar(30) COLLATE utf8_bin NOT NULL,
  `description` text COLLATE utf8_bin,
...
CREATE TABLE IF NOT EXISTS `vtiger_crmentityrel` (
  ...
  `relmodule` varchar(100) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_currencies` (
  ...
  `currency_name` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `currency_code` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `currency_symbol` varchar(11) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_currency_decimal_separator` (
  ...
  `currency_decimal_separator` varchar(2) COLLATE utf8_bin NOT NULL,
  `sortorderid` int(19) NOT NULL DEFAULT '0',
  `presence` int(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `vtiger_currency_grouping_pattern` (
  ...
  `currency_grouping_pattern` varchar(200) COLLATE utf8_bin NOT NULL,
  `sortorderid` int(19) NOT NULL DEFAULT '0',
  `presence` int(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `vtiger_currency_grouping_separator` (
  ...
  `currency_grouping_separator` varchar(2) COLLATE utf8_bin NOT NULL,
  `sortorderid` int(19) NOT NULL DEFAULT '0',
  `presence` int(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `vtiger_currency_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `currency_name` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `currency_code` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `currency_symbol` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `conversion_rate` decimal(12,5) DEFAULT NULL,
  `currency_status` varchar(25) COLLATE utf8_bin DEFAULT NULL,
  `defaultid` varchar(10) COLLATE utf8_bin NOT NULL DEFAULT '0',
  `deleted` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `vtiger_currency_symbol_placement` (
  ...
  `currency_symbol_placement` varchar(30) COLLATE utf8_bin NOT NULL,
  `sortorderid` int(19) NOT NULL DEFAULT '0',
  `presence` int(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `vtiger_customerdetails` (
  ...
  `portal` varchar(3) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_customerportal_prefs` (
  `tabid` int(19) NOT NULL,
  `prefkey` varchar(100) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_customview` (
  `cvid` int(19) NOT NULL,
  `viewname` varchar(100) COLLATE utf8_bin NOT NULL,
  `setdefault` int(1) DEFAULT '0',
  `setmetrics` int(1) DEFAULT '0',
  `entitytype` varchar(25) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_cvadvfilter` (
  ...
  `columnname` varchar(250) COLLATE utf8_bin DEFAULT '',
  `comparator` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `value` varchar(512) COLLATE utf8_bin DEFAULT NULL,
  `groupid` int(11) DEFAULT '1',
  `column_condition` varchar(255) COLLATE utf8_bin DEFAULT 'and',
...
CREATE TABLE IF NOT EXISTS `vtiger_cvadvfilter_grouping` (
  ...
  `cvid` int(19) NOT NULL,
  `group_condition` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `condition_expression` text COLLATE utf8_bin,
...
CREATE TABLE IF NOT EXISTS `vtiger_cvstdfilter` (
  `cvid` int(19) NOT NULL,
  `columnname` varchar(250) COLLATE utf8_bin DEFAULT '',
  `stdfilter` varchar(250) COLLATE utf8_bin DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `vtiger_datashare_grp2role` (
  `shareid` int(19) NOT NULL,
  `share_groupid` int(19) DEFAULT NULL,
  `to_roleid` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `permission` int(19) DEFAULT NULL,
  PRIMARY KEY (`shareid`),
...
CREATE TABLE IF NOT EXISTS `vtiger_datashare_grp2rs` (
  `shareid` int(19) NOT NULL,
  `share_groupid` int(19) DEFAULT NULL,
  `to_roleandsubid` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `permission` int(19) DEFAULT NULL,
  PRIMARY KEY (`shareid`),
...
CREATE TABLE IF NOT EXISTS `vtiger_datashare_module_rel` (
  `shareid` int(19) NOT NULL,
  `tabid` int(19) NOT NULL,
  `relationtype` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`shareid`),
...
CREATE TABLE IF NOT EXISTS `vtiger_datashare_role2group` (
  `shareid` int(19) NOT NULL,
  `share_roleid` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `to_groupid` int(19) DEFAULT NULL,
  `permission` int(19) DEFAULT NULL,
  PRIMARY KEY (`shareid`),
...
CREATE TABLE IF NOT EXISTS `vtiger_datashare_rs2grp` (
  `shareid` int(19) NOT NULL,
  `share_roleandsubid` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `to_groupid` int(19) DEFAULT NULL,
  `permission` int(19) DEFAULT NULL,
  PRIMARY KEY (`shareid`),
...
CREATE TABLE IF NOT EXISTS `vtiger_date_format` (
  ...
  `date_format` varchar(200) COLLATE utf8_bin NOT NULL,
  `sortorderid` int(19) NOT NULL DEFAULT '0',
  `presence` int(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `vtiger_defaultcv` (
  `tabid` int(19) NOT NULL,
  `defaultviewname` varchar(50) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_durationhrs` (
  ...
  `hrs` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `sortorderid` int(19) NOT NULL DEFAULT '0',
  `presence` int(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`hrsid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `vtiger_durationmins` (
  ...
  `mins` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `sortorderid` int(19) NOT NULL DEFAULT '0',
  `presence` int(1) NOT NULL DEFAULT '1',
  PRIMARY KEY (`minsid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `vtiger_duration_minutes` (
  ...
  `duration_minutes` varchar(200) COLLATE utf8_bin NOT NULL,
  `sortorderid` int(19) NOT NULL DEFAULT '0',
  `presence` int(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `vtiger_emaildetails` (
  ...
  `from_email` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT '',
  `to_email` text COLLATE utf8_bin,
  `cc_email` text COLLATE utf8_bin,
  `bcc_email` text COLLATE utf8_bin,
  `assigned_user_email` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT '',
  `idlists` text COLLATE utf8_bin,
  `email_flag` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT '',
  PRIMARY KEY (`emailid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_emailtemplates` (
  `foldername` varchar(100) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_entityname` (
  ...
  `modulename` varchar(50) COLLATE utf8_bin NOT NULL,
  `tablename` varchar(100) COLLATE utf8_bin NOT NULL,
  `fieldname` varchar(150) COLLATE utf8_bin NOT NULL,
  `entityidfield` varchar(150) COLLATE utf8_bin NOT NULL,
  `entityidcolumn` varchar(150) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`tabid`),
...
(40, 'ModComments', 'vtiger_modcomments', 'commentcontent', 'modcommentsid', 'modcommentsid'),
...
(48, 'Assets', 'vtiger_assets', 'assetname', 'assetsid', 'assetsid');
...
CREATE TABLE IF NOT EXISTS `vtiger_eventhandlers` (
  ...
  `handler_path` varchar(400) COLLATE utf8_bin NOT NULL,
  `handler_class` varchar(100) COLLATE utf8_bin NOT NULL,
  `cond` text COLLATE utf8_bin,
  `is_active` int(1) NOT NULL,
  `dependent_on` varchar(255) COLLATE utf8_bin DEFAULT '[]',
...
(10, 'vtiger.entity.aftersave', 'modules/WSAPP/WorkFlowHandlers/WSAPPAssignToTracker.php', 'WSAPPAssignToTracker', '', 1, '["VTEntityDelta"]'),
...
CREATE TABLE IF NOT EXISTS `vtiger_eventhandler_module` (
  ...
  `module_name` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `handler_class` varchar(100) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_eventstatus` (
  ...
  `eventstatus` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_expectedresponse` (
  ...
  `expectedresponse` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_faq` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `faq_no` varchar(100) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_faqcategories` (
  ...
  `faqcategories` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_faqstatus` (
  ...
  `faqstatus` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_feedback` (
  `userid` int(19) DEFAULT NULL,
  `dontshow` varchar(19) COLLATE utf8_bin DEFAULT 'false'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=751 ;
...
(34, 560, 'servicename', 'vtiger_service', 1, '2', 'servicename', 'Service Name', 1, 0, '', 100, 1, 91, 1, 'V~M', 0, 1, 'BAS', 1, '', 1),
(34, 561, 'service_no', 'vtiger_service', 1, '4', 'service_no', 'Service No', 1, 0, '', 100, 2, 91, 1, 'V~O', 3, 0, 'BAS', 0, '', 1),
(34, 562, 'discontinued', 'vtiger_service', 1, '56', 'discontinued', 'Service Active', 1, 2, '', 100, 4, 91, 1, 'V~O', 2, 3, 'BAS', 1, '', 0),
(34, 563, 'sales_start_date', 'vtiger_service', 1, '5', 'sales_start_date', 'Sales Start Date', 1, 2, '', 100, 9, 91, 1, 'D~O', 1, NULL, 'BAS', 1, '', 0),
(34, 564, 'sales_end_date', 'vtiger_service', 1, '5', 'sales_end_date', 'Sales End Date', 1, 2, '', 100, 10, 91, 1, 'D~O~OTH~GE~sales_start_date~Sales Start Date', 1, NULL, 'BAS', 1, '', 0),
(34, 565, 'start_date', 'vtiger_service', 1, '5', 'start_date', 'Support Start Date', 1, 2, '', 100, 11, 91, 1, 'D~O', 1, NULL, 'BAS', 1, '', 0),
(34, 566, 'expiry_date', 'vtiger_service', 1, '5', 'expiry_date', 'Support Expiry Date', 1, 2, '', 100, 12, 91, 1, 'D~O~OTH~GE~start_date~Start Date', 1, NULL, 'BAS', 1, '', 0),
(34, 567, 'website', 'vtiger_service', 1, '17', 'website', 'Website', 1, 2, '', 100, 6, 91, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(34, 568, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 0, '', 100, 13, 91, 2, 'DT~O', 3, 0, 'BAS', 0, '', 0),
(34, 569, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 0, '', 100, 14, 91, 2, 'DT~O', 3, 0, 'BAS', 0, '', 0),
(34, 570, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 16, 91, 3, 'V~O', 3, 0, 'BAS', 0, '', 0),
(34, 571, 'service_usageunit', 'vtiger_service', 1, '15', 'service_usageunit', 'Usage Unit', 1, 2, '', 100, 3, 91, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(34, 572, 'qty_per_unit', 'vtiger_service', 1, '1', 'qty_per_unit', 'No of Units', 1, 2, '', 100, 5, 91, 1, 'N~O', 1, NULL, 'BAS', 1, '', 1),
(34, 573, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Owner', 1, 0, '', 100, 8, 91, 1, 'I~O', 1, NULL, 'BAS', 1, '', 0),
(34, 574, 'servicecategory', 'vtiger_service', 1, '15', 'servicecategory', 'Service Category', 1, 2, '', 100, 7, 91, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(34, 575, 'unit_price', 'vtiger_service', 1, '72', 'unit_price', 'Price', 1, 0, '', 100, 1, 92, 1, 'N~O', 2, 2, 'BAS', 0, '', 1),
(34, 576, 'taxclass', 'vtiger_service', 1, '83', 'taxclass', 'Tax Class', 1, 2, '', 100, 4, 92, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(34, 577, 'commissionrate', 'vtiger_service', 1, '9', 'commissionrate', 'Commission Rate', 1, 2, '', 100, 2, 92, 1, 'N~O', 1, NULL, 'BAS', 1, '', 1),
(34, 578, 'description', 'vtiger_crmentity', 1, '19', 'description', 'Description', 1, 2, '', 100, 1, 94, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(40, 579, 'commentcontent', 'vtiger_modcomments', 1, '19', 'commentcontent', 'Comment', 1, 0, '', 100, 4, 95, 1, 'V~M', 0, 4, 'BAS', 2, '', 1),
(40, 580, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 0, '', 100, 1, 96, 1, 'V~M', 0, 1, 'BAS', 2, '', 1),
(40, 581, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 0, '', 100, 5, 96, 2, 'DT~O', 0, 2, 'BAS', 0, '', 0),
(40, 582, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 0, '', 100, 6, 96, 2, 'DT~O', 0, 3, 'BAS', 0, '', 0),
(40, 583, 'related_to', 'vtiger_modcomments', 1, '10', 'related_to', 'Related To', 1, 2, '', 100, 2, 96, 1, 'V~M', 2, 5, 'BAS', 2, '', 0),
(40, 584, 'smcreatorid', 'vtiger_crmentity', 1, '52', 'creator', 'Creator', 1, 2, '', 100, 4, 96, 2, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(40, 585, 'parent_comments', 'vtiger_modcomments', 1, '10', 'parent_comments', 'Related To Comments', 1, 2, '', 100, 7, 96, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(43, 586, 'projectmilestonename', 'vtiger_projectmilestone', 1, '2', 'projectmilestonename', 'Project Milestone Name', 1, 2, '', 100, 1, 98, 1, 'V~M', 0, 1, 'BAS', 1, '', 1),
(43, 587, 'projectmilestonedate', 'vtiger_projectmilestone', 1, '5', 'projectmilestonedate', 'Milestone Date', 1, 2, '', 100, 5, 98, 1, 'D~O', 0, 3, 'BAS', 1, '', 1),
(43, 588, 'projectid', 'vtiger_projectmilestone', 1, '10', 'projectid', 'Related to', 1, 0, '', 100, 4, 98, 1, 'V~M', 0, 4, 'BAS', 1, '', 0),
(43, 589, 'projectmilestonetype', 'vtiger_projectmilestone', 1, '15', 'projectmilestonetype', 'Type', 1, 2, '', 100, 7, 98, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(43, 590, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 2, '', 100, 6, 98, 1, 'V~M', 0, 2, 'BAS', 1, '', 0),
(43, 591, 'projectmilestone_no', 'vtiger_projectmilestone', 2, '4', 'projectmilestone_no', 'Project Milestone No', 1, 0, '', 100, 2, 98, 1, 'V~O', 3, 4, 'BAS', 0, '', 0),
(43, 592, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 2, '', 100, 1, 99, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(43, 593, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 2, '', 100, 2, 99, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(43, 594, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 3, 99, 3, 'V~O', 3, 0, 'BAS', 0, '', 0),
(43, 595, 'description', 'vtiger_crmentity', 1, '19', 'description', 'description', 1, 2, '', 100, 1, 100, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(44, 596, 'projecttaskname', 'vtiger_projecttask', 1, '2', 'projecttaskname', 'Project Task Name', 1, 2, '', 100, 1, 101, 1, 'V~M', 0, 1, 'BAS', 1, '', 1),
(44, 597, 'projecttasktype', 'vtiger_projecttask', 1, '15', 'projecttasktype', 'Type', 1, 2, '', 100, 4, 101, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(44, 598, 'projecttaskpriority', 'vtiger_projecttask', 1, '15', 'projecttaskpriority', 'Priority', 1, 2, '', 100, 3, 101, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(44, 599, 'projectid', 'vtiger_projecttask', 1, '10', 'projectid', 'Related to', 1, 0, '', 100, 6, 101, 1, 'V~M', 0, 5, 'BAS', 1, '', 0),
(44, 600, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 2, '', 100, 7, 101, 1, 'V~M', 0, 2, 'BAS', 1, '', 1),
(44, 601, 'projecttasknumber', 'vtiger_projecttask', 1, '7', 'projecttasknumber', 'Project Task Number', 1, 2, '', 100, 5, 101, 1, 'I~O', 1, NULL, 'BAS', 1, '', 0),
(44, 602, 'projecttask_no', 'vtiger_projecttask', 2, '4', 'projecttask_no', 'Project Task No', 1, 0, '', 100, 2, 101, 1, 'V~O', 3, 4, 'BAS', 0, '', 0),
(44, 603, 'projecttaskprogress', 'vtiger_projecttask', 1, '15', 'projecttaskprogress', 'Progress', 1, 2, '', 100, 1, 102, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(44, 604, 'projecttaskhours', 'vtiger_projecttask', 1, '7', 'projecttaskhours', 'Worked Hours', 1, 2, '', 100, 2, 102, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(44, 605, 'startdate', 'vtiger_projecttask', 1, '5', 'startdate', 'Start Date', 1, 2, '', 100, 3, 102, 1, 'D~O', 0, 3, 'BAS', 1, '', 1),
(44, 606, 'enddate', 'vtiger_projecttask', 1, '5', 'enddate', 'End Date', 1, 2, '', 100, 4, 102, 1, 'D~O~OTH~GE~startdate~Start Date', 1, NULL, 'BAS', 1, '', 1),
(44, 607, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 2, '', 100, 5, 102, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(44, 608, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 2, '', 100, 6, 102, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(44, 609, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 7, 102, 3, 'V~O', 3, 0, 'BAS', 0, '', 0),
(44, 610, 'description', 'vtiger_crmentity', 1, '19', 'description', 'description', 1, 2, '', 100, 1, 103, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(45, 611, 'projectname', 'vtiger_project', 1, '2', 'projectname', 'Project Name', 1, 2, '', 100, 1, 104, 1, 'V~M', 0, 1, 'BAS', 1, '', 1),
(45, 612, 'startdate', 'vtiger_project', 1, '23', 'startdate', 'Start Date', 1, 2, '', 100, 3, 104, 1, 'D~O', 0, 3, 'BAS', 1, '', 1),
(45, 613, 'targetenddate', 'vtiger_project', 1, '23', 'targetenddate', 'Target End Date', 1, 2, '', 100, 5, 104, 1, 'D~O~OTH~GE~startdate~Start Date', 0, 4, 'BAS', 1, '', 1),
(45, 614, 'actualenddate', 'vtiger_project', 1, '23', 'actualenddate', 'Actual End Date', 1, 2, '', 100, 6, 104, 1, 'D~O~OTH~GE~startdate~Start Date', 1, NULL, 'BAS', 1, '', 0),
(45, 615, 'projectstatus', 'vtiger_project', 1, '15', 'projectstatus', 'Status', 1, 2, '', 100, 7, 104, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(45, 616, 'projecttype', 'vtiger_project', 1, '15', 'projecttype', 'Type', 1, 2, '', 100, 8, 104, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(45, 617, 'linktoaccountscontacts', 'vtiger_project', 1, '10', 'linktoaccountscontacts', 'Related to', 1, 2, '', 100, 9, 104, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(45, 618, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 2, '', 100, 4, 104, 1, 'V~M', 0, 2, 'BAS', 1, '', 1),
(45, 619, 'project_no', 'vtiger_project', 2, '4', 'project_no', 'Project No', 1, 0, '', 100, 2, 104, 1, 'V~O', 3, 0, 'BAS', 0, '', 0),
(45, 620, 'targetbudget', 'vtiger_project', 1, '7', 'targetbudget', 'Target Budget', 1, 2, '', 100, 1, 105, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(45, 621, 'projecturl', 'vtiger_project', 1, '17', 'projecturl', 'Project Url', 1, 2, '', 100, 2, 105, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(45, 622, 'projectpriority', 'vtiger_project', 1, '15', 'projectpriority', 'Priority', 1, 2, '', 100, 3, 105, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(45, 623, 'progress', 'vtiger_project', 1, '15', 'progress', 'Progress', 1, 2, '', 100, 4, 105, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(45, 624, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 2, '', 100, 5, 105, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(45, 625, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 2, '', 100, 6, 105, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(45, 626, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 7, 105, 3, 'V~O', 3, 0, 'BAS', 0, '', 0),
(45, 627, 'description', 'vtiger_crmentity', 1, '19', 'description', 'description', 1, 2, '', 100, 1, 106, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(47, 628, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 0, '', 100, 2, 107, 1, 'V~M', 1, NULL, 'BAS', 1, '', 1),
(47, 629, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 0, '', 100, 5, 107, 2, 'DT~O', 1, NULL, 'BAS', 0, '', 0),
(47, 630, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 0, '', 100, 6, 107, 2, 'DT~O', 1, NULL, 'BAS', 0, '', 0),
(47, 631, 'message', 'vtiger_smsnotifier', 1, '21', 'message', 'message', 1, 0, '', 100, 1, 107, 1, 'V~M', 1, NULL, 'BAS', 1, '', 1),
(47, 632, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 7, 107, 3, 'V~O', 1, NULL, 'BAS', 0, '', 0),
(48, 633, 'asset_no', 'vtiger_assets', 1, '4', 'asset_no', 'Asset No', 1, 0, '', 100, 2, 110, 1, 'V~O', 3, 0, 'BAS', 0, '\n                    ', 1),
(48, 634, 'product', 'vtiger_assets', 1, '10', 'product', 'Product Name', 1, 2, '', 100, 3, 110, 1, 'V~M', 0, 3, 'BAS', 1, '\n                    ', 1),
(48, 635, 'serialnumber', 'vtiger_assets', 1, '2', 'serialnumber', 'Serial Number', 1, 2, '', 100, 4, 110, 1, 'V~M', 0, 5, 'BAS', 1, '\n                    ', 0),
(48, 636, 'datesold', 'vtiger_assets', 1, '5', 'datesold', 'Date Sold', 1, 2, '', 100, 5, 110, 1, 'D~M~OTH~GE~datesold~Date Sold', 0, 0, 'BAS', 1, '\n                    ', 0),
(48, 637, 'dateinservice', 'vtiger_assets', 1, '5', 'dateinservice', 'Date in Service', 1, 2, '', 100, 6, 110, 1, 'D~M~OTH~GE~dateinservice~Date in Service', 0, 4, 'BAS', 1, '\n                    ', 0),
(48, 638, 'assetstatus', 'vtiger_assets', 1, '15', 'assetstatus', 'Status', 1, 2, '', 100, 7, 110, 1, 'V~M', 0, 0, 'BAS', 1, '\n                    ', 0),
(48, 639, 'tagnumber', 'vtiger_assets', 1, '2', 'tagnumber', 'Tag Number', 1, 2, '', 100, 8, 110, 1, 'V~O', 1, NULL, 'BAS', 1, '\n                    ', 0),
(48, 640, 'invoiceid', 'vtiger_assets', 1, '10', 'invoiceid', 'Invoice Name', 1, 2, '', 100, 9, 110, 1, 'V~O', 1, NULL, 'BAS', 1, '\n                    ', 0),
(48, 641, 'shippingmethod', 'vtiger_assets', 1, '2', 'shippingmethod', 'Shipping Method', 1, 2, '', 100, 10, 110, 1, 'V~O', 1, NULL, 'BAS', 1, '\n                    ', 0),
(48, 642, 'shippingtrackingnumber', 'vtiger_assets', 1, '2', 'shippingtrackingnumber', 'Shipping Tracking Number', 1, 2, '', 100, 11, 110, 1, 'V~O', 1, NULL, 'BAS', 1, '\n                    ', 0),
(48, 643, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 2, '', 100, 4, 110, 1, 'V~M', 0, 2, 'BAS', 1, '\n                    ', 0),
(48, 644, 'assetname', 'vtiger_assets', 1, '1', 'assetname', 'Asset Name', 1, 0, '', 100, 12, 110, 1, 'V~M', 0, 6, 'BAS', 1, '\n                    ', 1),
(48, 645, 'account', 'vtiger_assets', 1, '10', 'account', 'Customer Name', 1, 2, '', 100, 13, 110, 1, 'V~M', 0, 0, 'BAS', 1, '\n                    ', 1),
(48, 646, 'contact', 'vtiger_assets', 1, '10', 'contact', 'Contact Name', 1, 2, '', 100, 14, 110, 1, 'V~O', 0, 0, 'BAS', 1, '\n                    ', 0),
(48, 647, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 0, '', 100, 14, 110, 2, 'DT~O', 3, 0, 'BAS', 0, '\n                    ', 0),
(48, 648, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 0, '', 100, 15, 110, 2, 'DT~O', 3, 0, 'BAS', 0, '\n                    ', 0),
(48, 649, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 16, 110, 3, 'V~O', 3, 0, 'BAS', 0, '\n                    ', 0),
(48, 650, 'description', 'vtiger_crmentity', 1, '19', 'description', 'Notes', 1, 2, '', 100, 1, 112, 1, 'V~O', 1, NULL, 'BAS', 1, '\n                    ', 0),
...
(44, 690, 'projecttaskstatus', 'vtiger_projecttask', 1, '15', 'projecttaskstatus', 'Status', 1, 2, '', 100, 8, 101, 1, 'V~O', 0, 6, 'BAS', 1, '', 0),
(40, 691, 'customer', 'vtiger_modcomments', 1, '10', 'customer', 'Customer', 1, 2, '', 100, 5, 95, 3, 'V~O', 1, NULL, 'BAS', 1, '', 0),
...
(40, 710, 'userid', 'vtiger_modcomments', 1, '10', 'userid', 'UserId', 1, 2, '', 100, 6, 95, 3, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(40, 711, 'reasontoedit', 'vtiger_modcomments', 1, '19', 'reasontoedit', 'ReasonToEdit', 1, 2, '', 100, 7, 95, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
...
(2, 724, 'smcreatorid', 'vtiger_crmentity', 1, '53', 'created_user_id', 'Created By', 1, 2, '', 100, 21, 1, 2, 'V~O', 3, 7, 'BAS', 0, '', 0),
(4, 725, 'smcreatorid', 'vtiger_crmentity', 1, '53', 'created_user_id', 'Created By', 1, 2, '', 100, 30, 4, 2, 'V~O', 3, 7, 'BAS', 0, '', 0),
(6, 726, 'smcreatorid', 'vtiger_crmentity', 1, '53', 'created_user_id', 'Created By', 1, 2, '', 100, 25, 9, 2, 'V~O', 3, 5, 'BAS', 0, '', 0),
(7, 727, 'smcreatorid', 'vtiger_crmentity', 1, '53', 'created_user_id', 'Created By', 1, 2, '', 100, 25, 13, 2, 'V~O', 3, 7, 'BAS', 0, '', 0),
(9, 729, 'smcreatorid', 'vtiger_crmentity', 1, '53', 'created_user_id', 'Created By', 1, 2, '', 100, 23, 19, 2, 'V~O', 3, 5, 'BAS', 0, '', 0),
(13, 730, 'smcreatorid', 'vtiger_crmentity', 1, '53', 'created_user_id', 'Created By', 1, 2, '', 100, 20, 25, 2, 'V~O', 3, 5, 'BAS', 0, '', 0),
(18, 734, 'smcreatorid', 'vtiger_crmentity', 1, '53', 'created_user_id', 'Created By', 1, 2, '', 100, 14, 42, 2, 'V~O', 3, 4, 'BAS', 0, '', 0),
(21, 737, 'smcreatorid', 'vtiger_crmentity', 1, '53', 'created_user_id', 'Created By', 1, 2, '', 100, 26, 55, 2, 'V~O', 3, 2, 'BAS', 0, '', 0),
(23, 739, 'smcreatorid', 'vtiger_crmentity', 1, '53', 'created_user_id', 'Created By', 1, 2, '', 100, 26, 67, 2, 'V~O', 3, 2, 'BAS', 0, '', 0),
(40, 744, 'smcreatorid', 'vtiger_crmentity', 1, '53', 'created_user_id', 'Created By', 1, 2, '', 100, 8, 95, 2, 'V~O', 3, 6, 'BAS', 0, '', 0),
(43, 745, 'smcreatorid', 'vtiger_crmentity', 1, '53', 'created_user_id', 'Created By', 1, 2, '', 100, 8, 98, 2, 'V~O', 3, 5, 'BAS', 0, '', 0),
(44, 746, 'smcreatorid', 'vtiger_crmentity', 1, '53', 'created_user_id', 'Created By', 1, 2, '', 100, 9, 101, 2, 'V~O', 3, 7, 'BAS', 0, '', 0),
(45, 747, 'smcreatorid', 'vtiger_crmentity', 1, '53', 'created_user_id', 'Created By', 1, 2, '', 100, 10, 104, 2, 'V~O', 3, 5, 'BAS', 0, '', 0),
...
(583, 'ModComments', 'Leads', NULL, NULL),
(583, 'ModComments', 'Contacts', NULL, NULL),
(583, 'ModComments', 'Accounts', NULL, NULL),
(585, 'ModComments', 'ModComments', NULL, NULL),
(583, 'ModComments', 'Potentials', NULL, NULL),
(588, 'ProjectMilestone', 'Project', NULL, NULL),
(599, 'ProjectTask', 'Project', NULL, NULL),
(583, 'ModComments', 'ProjectTask', NULL, NULL),
(617, 'Project', 'Accounts', NULL, NULL),
(617, 'Project', 'Contacts', NULL, NULL),
(583, 'ModComments', 'Project', NULL, NULL),
(634, 'Assets', 'Products', NULL, NULL),
(640, 'Assets', 'Invoice', NULL, NULL),
(645, 'Assets', 'Accounts', NULL, NULL),
(646, 'Assets', 'Contacts', NULL, NULL),
...
(583, 'ModComments', 'HelpDesk', NULL, NULL),
(583, 'ModComments', 'Faq', NULL, NULL),
...
CREATE TABLE IF NOT EXISTS `vtiger_freetags` (
  ...
  `raw_tag` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_glacct` (
  ...
  `glacct` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_group2rs` (
  `groupid` int(19) NOT NULL,
  `roleandsubid` varchar(255) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_homedashbd` (
  ...
  `dashbdname` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `dashbdtype` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`stuffid`),
...
CREATE TABLE IF NOT EXISTS `vtiger_homedefault` (
  `stuffid` int(19) NOT NULL DEFAULT '0',
  `hometype` varchar(30) COLLATE utf8_bin NOT NULL,
  `maxentries` int(19) DEFAULT NULL,
  `setype` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`stuffid`),
  KEY `stuff_stuffid_idx` (`stuffid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_homereportchart` (
  ...
  `reportcharttype` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`stuffid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_homestuff` (
  ...
  `stufftype` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `userid` int(19) NOT NULL,
  `visible` int(10) NOT NULL DEFAULT '0',
  `stufftitle` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`stuffid`),
  KEY `stuff_stuffid_idx` (`stuffid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_import_maps` (
  ...
  `module` varchar(36) COLLATE utf8_bin NOT NULL,
  `content` longblob,
  `has_header` int(1) NOT NULL DEFAULT '1',
  `deleted` int(1) NOT NULL DEFAULT '0',
  `date_entered` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `date_modified` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `assigned_user_id` varchar(36) COLLATE utf8_bin DEFAULT NULL,
  `is_published` varchar(3) COLLATE utf8_bin NOT NULL DEFAULT 'no',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `vtiger_industry` (
  ...
  `industry` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_inventorynotification` (
  ...
  `notificationname` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `notificationsubject` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `notificationbody` text COLLATE utf8_bin,
...
CREATE TABLE IF NOT EXISTS `vtiger_inventorytaxinfo` (
  ...
  `taxname` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `taxlabel` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_invoice` (
  ...
  `notes` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `invoicedate` date DEFAULT NULL,
  `duedate` date DEFAULT NULL,
  `invoiceterms` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `type` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  ...
  `taxtype` varchar(25) COLLATE utf8_bin DEFAULT NULL,
  `discount_percent` decimal(25,3) DEFAULT NULL,
  `discount_amount` decimal(25,8) DEFAULT NULL,
  `s_h_amount` decimal(25,8) DEFAULT NULL,
  `shipping` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `accountid` int(19) DEFAULT NULL,
  `terms_conditions` text COLLATE utf8_bin,
  `purchaseorder` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `invoicestatus` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `invoice_no` varchar(100) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_invoicestatus` (
  ...
  `invoicestatus` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_invoice_recurring_info` (
  ...
  `recurring_frequency` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `start_period` date DEFAULT NULL,
  `end_period` date DEFAULT NULL,
  `last_recurring_date` date DEFAULT NULL,
  `payment_duration` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `invoice_status` varchar(200) COLLATE utf8_bin DEFAULT NULL,
...
(1, 'English', 'en_us', 'US English', '2015-01-12 05:03:56', NULL, 1, 1),
(2, 'British English', 'en_gb', 'British English', '2015-01-12 05:04:38', NULL, 0, 1),
(3, 'Język Polski', 'pl_pl', 'Język Polski', '2015-01-12 05:04:48', NULL, 0, 1),
(4, 'Brazilian', 'pt_br', 'PT Brasil', '2015-01-12 05:04:48', NULL, 0, 1),
(5, 'Pack de langue français', 'fr_fr', 'Pack de langue français', '2015-01-12 05:04:48', NULL, 0, 1),
(6, 'Romana', 'ro_ro', 'Romana', '2015-01-12 05:04:48', NULL, 0, 1),
(7, 'Hungarian', 'hu_hu', 'HU Magyar', '2015-01-12 05:04:39', NULL, 0, 1),
(8, 'Dutch', 'nl_nl', 'NL-Dutch', '2015-01-12 05:04:39', NULL, 0, 1),
(9, 'Spanish', 'es_es', 'ES Spanish', '2015-01-12 05:04:40', NULL, 0, 1),
(10, 'Deutsch', 'de_de', 'DE Deutsch', '2015-01-12 05:04:45', NULL, 0, 1),
(11, 'Arabic', 'ar_ae', 'Arabic', '2015-01-12 05:05:06', NULL, 0, 1),
(12, 'Russian', 'ru_ru', 'Russian', '2015-01-12 05:04:46', NULL, 0, 1),
(13, 'Italian', 'it_it', 'IT Italian', '2015-01-12 05:04:46', NULL, 0, 1),
(14, 'Swedish', 'sv_se', 'Swedish', '2015-01-12 05:05:06', NULL, 0, 1),
(15, 'Mexican Spanish', 'es_mx', 'ES Mexico', '2015-01-12 05:04:47', NULL, 0, 1),
(16, 'Turkce', 'tr_tr', 'Turkce Dil Paketi', '2015-01-12 05:04:47', NULL, 0, 1);
...
CREATE TABLE IF NOT EXISTS `vtiger_leadaddress` (
  ...
  `mobile` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `fax` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `lane` varchar(250) COLLATE utf8_bin DEFAULT NULL,
  `leadaddresstype` varchar(30) COLLATE utf8_bin DEFAULT 'Billing',
...
CREATE TABLE IF NOT EXISTS `vtiger_leaddetails` (
  ...
  `lead_no` varchar(100) COLLATE utf8_bin NOT NULL,
  `email` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  ...
  `annualrevenue` decimal(25,8) DEFAULT NULL,
  `industry` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `campaign` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `rating` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `leadstatus` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `leadsource` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `converted` int(1) DEFAULT '0',
  `designation` varchar(50) COLLATE utf8_bin DEFAULT 'SalesMan',
  `licencekeystatus` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `space` varchar(250) COLLATE utf8_bin DEFAULT NULL,
  `comments` text COLLATE utf8_bin,
  `priority` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `demorequest` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `partnercontact` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `productversion` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `product` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `maildate` date DEFAULT NULL,
  `nextstepdate` date DEFAULT NULL,
  `fundingsituation` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `purpose` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `evaluationstatus` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `transferdate` date DEFAULT NULL,
  `revenuetype` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `noofemployees` int(50) DEFAULT NULL,
  `secondaryemail` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `assignleadchk` int(1) DEFAULT '0',
  `emailoptout` varchar(3) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`leadid`),
...
CREATE TABLE IF NOT EXISTS `vtiger_leadsource` (
  ...
  `leadsource` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_leadstage` (
  ...
  `stage` varchar(200) COLLATE utf8_bin NOT NULL,
  `sortorderid` int(19) NOT NULL DEFAULT '0',
  `presence` int(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `vtiger_leadstatus` (
  ...
  `leadstatus` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_lead_view` (
  ...
  `lead_view` varchar(200) COLLATE utf8_bin NOT NULL,
  `sortorderid` int(19) NOT NULL DEFAULT '0',
  `presence` int(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `vtiger_links` (
  ...
  `linktype` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `linklabel` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `linkurl` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `linkicon` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `sequence` int(11) DEFAULT NULL,
  `handler_path` varchar(128) COLLATE utf8_bin DEFAULT NULL,
  `handler_class` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
(8, 4, 'LISTVIEWSIDEBARWIDGET', 'Google Contacts', 'module=Google&view=List&sourcemodule=Contacts', '', 0, NULL, NULL, NULL),
(9, 9, 'LISTVIEWSIDEBARWIDGET', 'Google Calendar', 'module=Google&view=List&sourcemodule=Calendar', '', 0, NULL, NULL, NULL),
(10, 40, 'HEADERSCRIPT', 'ModCommentsCommonHeaderScript', 'modules/ModComments/ModCommentsCommon.js', '', 0, NULL, NULL, NULL),
(11, 7, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(12, 4, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(13, 6, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(14, 2, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(20, 47, 'DETAILVIEWBASIC', 'LBL_CHECK_STATUS', 'javascript:SMSNotifier.checkstatus($RECORD$)', 'themes/images/reload.gif', 0, NULL, NULL, NULL),
(22, 47, 'HEADERSCRIPT', 'SMSNotifierCommonJS', 'modules/SMSNotifier/SMSNotifierCommon.js', '', 0, NULL, NULL, NULL),
(23, 7, 'LISTVIEWBASIC', 'Send SMS', 'SMSNotifierCommon.displaySelectWizard(this, ''$MODULE$'');', '', 0, NULL, NULL, NULL),
(24, 7, 'DETAILVIEWBASIC', 'Send SMS', 'javascript:SMSNotifierCommon.displaySelectWizard_DetailView(''$MODULE$'', ''$RECORD$'');', '', 0, NULL, NULL, NULL),
(25, 4, 'LISTVIEWBASIC', 'Send SMS', 'SMSNotifierCommon.displaySelectWizard(this, ''$MODULE$'');', '', 0, NULL, NULL, NULL),
(26, 4, 'DETAILVIEWBASIC', 'Send SMS', 'javascript:SMSNotifierCommon.displaySelectWizard_DetailView(''$MODULE$'', ''$RECORD$'');', '', 0, NULL, NULL, NULL),
(27, 6, 'LISTVIEWBASIC', 'Send SMS', 'SMSNotifierCommon.displaySelectWizard(this, ''$MODULE$'');', '', 0, NULL, NULL, NULL),
(28, 6, 'DETAILVIEWBASIC', 'Send SMS', 'javascript:SMSNotifierCommon.displaySelectWizard_DetailView(''$MODULE$'', ''$RECORD$'');', '', 0, NULL, NULL, NULL),
(29, 44, 'DETAILVIEWBASIC', 'Add Note', 'index.php?module=Documents&action=EditView&return_module=ProjectTask&return_action=DetailView&return_id=$RECORD$&parent_id=$RECORD$', '', 0, 'modules/Documents/Documents.php', 'Documents', 'isLinkPermitted'),
(30, 44, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(31, 45, 'DETAILVIEWBASIC', 'Add Project Task', 'index.php?module=ProjectTask&action=EditView&projectid=$RECORD$&return_module=Project&return_action=DetailView&return_id=$RECORD$', '', 0, 'modules/ProjectTask/ProjectTask.php', 'ProjectTask', 'isLinkPermitted'),
(32, 45, 'DETAILVIEWBASIC', 'Add Note', 'index.php?module=Documents&action=EditView&return_module=Project&return_action=DetailView&return_id=$RECORD$&parent_id=$RECORD$', '', 1, 'modules/Documents/Documents.php', 'Documents', 'isLinkPermitted'),
(33, 45, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(34, 2, 'DASHBOARDWIDGET', 'History', 'index.php?module=Potentials&view=ShowWidget&name=History', '', 1, NULL, NULL, NULL),
(35, 2, 'DASHBOARDWIDGET', 'Upcoming Activities', 'index.php?module=Potentials&view=ShowWidget&name=CalendarActivities', '', 2, NULL, NULL, NULL),
(36, 2, 'DASHBOARDWIDGET', 'Funnel', 'index.php?module=Potentials&view=ShowWidget&name=GroupedBySalesStage', '', 3, NULL, NULL, NULL),
(37, 2, 'DASHBOARDWIDGET', 'Potentials by Stage', 'index.php?module=Potentials&view=ShowWidget&name=GroupedBySalesPerson', '', 4, NULL, NULL, NULL),
(38, 2, 'DASHBOARDWIDGET', 'Pipelined Amount', 'index.php?module=Potentials&view=ShowWidget&name=PipelinedAmountPerSalesPerson', '', 5, NULL, NULL, NULL),
(39, 2, 'DASHBOARDWIDGET', 'Total Revenue', 'index.php?module=Potentials&view=ShowWidget&name=TotalRevenuePerSalesPerson', '', 6, NULL, NULL, NULL),
(40, 2, 'DASHBOARDWIDGET', 'Top Potentials', 'index.php?module=Potentials&view=ShowWidget&name=TopPotentials', '', 7, NULL, NULL, NULL),
(41, 2, 'DASHBOARDWIDGET', 'Overdue Activities', 'index.php?module=Potentials&view=ShowWidget&name=OverdueActivities', '', 9, NULL, NULL, NULL),
(42, 6, 'DASHBOARDWIDGET', 'History', 'index.php?module=Accounts&view=ShowWidget&name=History', '', 1, NULL, NULL, NULL),
(43, 6, 'DASHBOARDWIDGET', 'Upcoming Activities', 'index.php?module=Accounts&view=ShowWidget&name=CalendarActivities', '', 2, NULL, NULL, NULL),
(44, 6, 'DASHBOARDWIDGET', 'Overdue Activities', 'index.php?module=Accounts&view=ShowWidget&name=OverdueActivities', '', 3, NULL, NULL, NULL),
(45, 4, 'DASHBOARDWIDGET', 'History', 'index.php?module=Contacts&view=ShowWidget&name=History', '', 1, NULL, NULL, NULL),
(46, 4, 'DASHBOARDWIDGET', 'Upcoming Activities', 'index.php?module=Contacts&view=ShowWidget&name=CalendarActivities', '', 2, NULL, NULL, NULL),
(47, 4, 'DASHBOARDWIDGET', 'Overdue Activities', 'index.php?module=Contacts&view=ShowWidget&name=OverdueActivities', '', 3, NULL, NULL, NULL),
(48, 7, 'DASHBOARDWIDGET', 'History', 'index.php?module=Leads&view=ShowWidget&name=History', '', 1, NULL, NULL, NULL),
(49, 7, 'DASHBOARDWIDGET', 'Upcoming Activities', 'index.php?module=Leads&view=ShowWidget&name=CalendarActivities', '', 2, NULL, NULL, NULL),
(50, 7, 'DASHBOARDWIDGET', 'Leads by Status', 'index.php?module=Leads&view=ShowWidget&name=LeadsByStatus', '', 4, NULL, NULL, NULL),
(51, 7, 'DASHBOARDWIDGET', 'Leads by Source', 'index.php?module=Leads&view=ShowWidget&name=LeadsBySource', '', 5, NULL, NULL, NULL),
(52, 7, 'DASHBOARDWIDGET', 'Leads by Industry', 'index.php?module=Leads&view=ShowWidget&name=LeadsByIndustry', '', 6, NULL, NULL, NULL),
(53, 7, 'DASHBOARDWIDGET', 'Overdue Activities', 'index.php?module=Leads&view=ShowWidget&name=OverdueActivities', '', 7, NULL, NULL, NULL),
(54, 13, 'DASHBOARDWIDGET', 'Tickets by Status', 'index.php?module=HelpDesk&view=ShowWidget&name=TicketsByStatus', '', 1, NULL, NULL, NULL),
(55, 13, 'DASHBOARDWIDGET', 'Open Tickets', 'index.php?module=HelpDesk&view=ShowWidget&name=OpenTickets', '', 2, NULL, NULL, NULL),
(56, 3, 'DASHBOARDWIDGET', 'History', 'index.php?module=Home&view=ShowWidget&name=History', '', 1, NULL, NULL, NULL),
(57, 3, 'DASHBOARDWIDGET', 'Upcoming Activities', 'index.php?module=Home&view=ShowWidget&name=CalendarActivities', '', 2, NULL, NULL, NULL),
(58, 3, 'DASHBOARDWIDGET', 'Funnel', 'index.php?module=Potentials&view=ShowWidget&name=GroupedBySalesStage', '', 3, NULL, NULL, NULL),
(59, 3, 'DASHBOARDWIDGET', 'Potentials by Stage', 'index.php?module=Potentials&view=ShowWidget&name=GroupedBySalesPerson', '', 4, NULL, NULL, NULL),
(60, 3, 'DASHBOARDWIDGET', 'Pipelined Amount', 'index.php?module=Potentials&view=ShowWidget&name=PipelinedAmountPerSalesPerson', '', 5, NULL, NULL, NULL),
(61, 3, 'DASHBOARDWIDGET', 'Total Revenue', 'index.php?module=Potentials&view=ShowWidget&name=TotalRevenuePerSalesPerson', '', 6, NULL, NULL, NULL),
(62, 3, 'DASHBOARDWIDGET', 'Top Potentials', 'index.php?module=Potentials&view=ShowWidget&name=TopPotentials', '', 7, NULL, NULL, NULL),
(63, 3, 'DASHBOARDWIDGET', 'Leads by Status', 'index.php?module=Leads&view=ShowWidget&name=LeadsByStatus', '', 10, NULL, NULL, NULL),
(64, 3, 'DASHBOARDWIDGET', 'Leads by Source', 'index.php?module=Leads&view=ShowWidget&name=LeadsBySource', '', 11, NULL, NULL, NULL),
(65, 3, 'DASHBOARDWIDGET', 'Leads by Industry', 'index.php?module=Leads&view=ShowWidget&name=LeadsByIndustry', '', 12, NULL, NULL, NULL),
(66, 3, 'DASHBOARDWIDGET', 'Overdue Activities', 'index.php?module=Home&view=ShowWidget&name=OverdueActivities', '', 13, NULL, NULL, NULL),
(67, 3, 'DASHBOARDWIDGET', 'Tickets by Status', 'index.php?module=HelpDesk&view=ShowWidget&name=TicketsByStatus', '', 13, NULL, NULL, NULL),
(68, 3, 'DASHBOARDWIDGET', 'Open Tickets', 'index.php?module=HelpDesk&view=ShowWidget&name=OpenTickets', '', 14, NULL, NULL, NULL),
(69, 13, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(70, 15, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(99, 3, 'DASHBOARDWIDGET', 'Key Metrics', 'index.php?module=Home&view=ShowWidget&name=KeyMetrics', '', 0, NULL, NULL, NULL),
(100, 3, 'DASHBOARDWIDGET', 'Mini List', 'index.php?module=Home&view=ShowWidget&name=MiniList', '', 0, NULL, NULL, NULL),
(101, 3, 'DASHBOARDWIDGET', 'Tag Cloud', 'index.php?module=Home&view=ShowWidget&name=TagCloud', '', 0, NULL, NULL, NULL),
(102, 2, 'DASHBOARDWIDGET', 'Funnel Amount', 'index.php?module=Potentials&view=ShowWidget&name=FunnelAmount', '', 10, NULL, NULL, NULL),
(103, 3, 'DASHBOARDWIDGET', 'Funnel Amount', 'index.php?module=Potentials&view=ShowWidget&name=FunnelAmount', '', 10, NULL, NULL, NULL),
(104, 3, 'DASHBOARDWIDGET', 'Notebook', 'index.php?module=Home&view=ShowWidget&name=Notebook', '', 0, NULL, NULL, NULL),
(105, 6, 'DETAILVIEWSIDEBARWIDGET', 'Google Map', 'module=Google&view=Map&mode=showMap&viewtype=detail', '', 0, NULL, NULL, NULL),
...
(1, 'admin', '10.1.10.131', '0000-00-00 00:00:00', '2015-01-12 04:05:11', 'Signed in');
...
CREATE TABLE IF NOT EXISTS `vtiger_mailscanner` (
  ...
  `scannername` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `server` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `protocol` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `username` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `password` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `ssltype` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `sslmethod` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `connecturl` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `searchfor` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `markas` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `isvalid` int(1) DEFAULT NULL,
  `time_zone` varchar(10) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_mailscanner_actions` (
  ...
  `actiontype` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `module` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `lookup` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `sequence` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_mailscanner_folders` (
  ...
  `lastscan` varchar(30) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_mailscanner_ids` (
  `scannerid` int(11) DEFAULT NULL,
  `messageid` varchar(512) COLLATE utf8_bin DEFAULT NULL,
  `crmid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_mailscanner_rules` (
  `ruleid` int(11) NOT NULL AUTO_INCREMENT,
  `scannerid` int(11) DEFAULT NULL,
  `fromaddress` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `toaddress` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `subjectop` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `subject` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `bodyop` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `body` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `matchusing` varchar(5) COLLATE utf8_bin DEFAULT NULL,
  `sequence` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_mail_accounts` (
  ...
  `mail_id` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `account_name` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `mail_protocol` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `mail_username` varchar(50) COLLATE utf8_bin NOT NULL,
  `mail_password` varchar(250) COLLATE utf8_bin NOT NULL,
  `mail_servername` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `box_refresh` int(10) DEFAULT NULL,
  `mails_per_page` int(10) DEFAULT NULL,
  `ssltype` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `sslmeth` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `int_mailer` int(1) DEFAULT '0',
  `status` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `set_default` int(2) DEFAULT NULL,
  `sent_folder` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_manufacturer` (
  ...
  `manufacturer` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_modentity_num` (
  ...
  `semodule` varchar(50) COLLATE utf8_bin NOT NULL,
  `prefix` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT '',
  `start_id` varchar(50) COLLATE utf8_bin NOT NULL,
  `cur_id` varchar(50) COLLATE utf8_bin NOT NULL,
  `active` varchar(2) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`num_id`),
...
CREATE TABLE IF NOT EXISTS `vtiger_notificationscheduler` (
  ...
  `schedulednotificationname` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `active` int(1) DEFAULT NULL,
  `notificationsubject` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `notificationbody` text COLLATE utf8_bin,
  `label` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_opportunity_type` (
  ...
  `opportunity_type` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_organizationdetails` (
  ...
  `organizationname` varchar(60) COLLATE utf8_bin DEFAULT NULL,
  ...
  `fax` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `website` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `logoname` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `logo` text COLLATE utf8_bin,
  `vatid` varchar(100) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_org_share_action_mapping` (
  `share_action_id` int(19) NOT NULL,
  `share_action_name` varchar(200) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_parenttab` (
  ...
  `parenttab_label` varchar(100) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_picklist_dependency` (
  `id` int(11) NOT NULL,
  `tabid` int(19) NOT NULL,
  `sourcefield` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `targetfield` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `sourcevalue` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `targetvalues` text COLLATE utf8_bin,
  `criteria` text COLLATE utf8_bin,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_portal` (
  ...
  `portalname` varchar(200) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_postatus` (
  ...
  `postatus` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_postatushistory` (
  ...
  `vendorname` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `total` decimal(10,0) DEFAULT NULL,
  `postatus` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `lastmodified` datetime DEFAULT NULL,
  PRIMARY KEY (`historyid`),
...
CREATE TABLE IF NOT EXISTS `vtiger_potential` (
  `potentialid` int(19) NOT NULL DEFAULT '0',
  `potential_no` varchar(100) COLLATE utf8_bin NOT NULL,
  `related_to` int(19) DEFAULT NULL,
  `potentialname` varchar(120) COLLATE utf8_bin NOT NULL,
  `amount` decimal(25,8) DEFAULT NULL,
  `currency` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `closingdate` date DEFAULT NULL,
  `typeofrevenue` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `nextstep` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `private` int(1) DEFAULT '0',
  `probability` decimal(7,3) DEFAULT '0.000',
  `campaignid` int(19) DEFAULT NULL,
  `sales_stage` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `potentialtype` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `leadsource` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `productid` int(50) DEFAULT NULL,
  `productversion` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `quotationref` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `partnercontact` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_pricebook` (
  ...
  `pricebook_no` varchar(100) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_productcategory` (
  ...
  `productcategory` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_products` (
  `productid` int(11) NOT NULL,
  `product_no` varchar(100) COLLATE utf8_bin NOT NULL,
  `productname` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `productcode` varchar(40) COLLATE utf8_bin DEFAULT NULL,
  `productcategory` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  ...
  `commissionmethod` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `discontinued` int(1) NOT NULL DEFAULT '0',
  `usageunit` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `reorderlevel` int(11) DEFAULT NULL,
  `website` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `taxclass` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `mfr_part_no` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `vendor_part_no` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `serialno` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `qtyinstock` decimal(25,3) DEFAULT NULL,
  `productsheet` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `qtyindemand` int(11) DEFAULT NULL,
  `glacct` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `vendor_id` int(11) DEFAULT NULL,
  `imagename` text COLLATE utf8_bin,
  `currency_id` int(19) NOT NULL DEFAULT '1',
  PRIMARY KEY (`productid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_profile` (
  ...
  `profilename` varchar(50) COLLATE utf8_bin NOT NULL,
  `description` text COLLATE utf8_bin,
...
(2, 'prospecting', 1, 259, 2),
(3, 'initiated', 1, 260, 3),
(4, 'in progress', 1, 261, 4),
(5, 'waiting for feedback', 1, 262, 5),
(6, 'on hold', 1, 263, 6),
(7, 'completed', 1, 264, 7),
(8, 'delivered', 1, 265, 8),
(9, 'archived', 1, 266, 9);
...
CREATE TABLE IF NOT EXISTS `vtiger_purchaseorder` (
  ...
  `requisition_no` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `purchaseorder_no` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `tracking_no` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `contactid` int(19) DEFAULT NULL,
  `duedate` date DEFAULT NULL,
  `carrier` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `type` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `adjustment` decimal(25,8) DEFAULT NULL,
  `salescommission` decimal(25,3) DEFAULT NULL,
  `exciseduty` decimal(25,3) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_quotes` (
  ...
  `quotestage` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `validtill` date DEFAULT NULL,
  `contactid` int(19) DEFAULT NULL,
  `quote_no` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `subtotal` decimal(25,8) DEFAULT NULL,
  `carrier` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `shipping` varchar(100) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_quotestage` (
  ...
  `quotestage` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_recurringevents` (
  ...
  `recurringtype` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `recurringfreq` int(19) DEFAULT NULL,
  `recurringinfo` varchar(50) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_recurringtype` (
  ...
  `recurringtype` varchar(200) COLLATE utf8_bin NOT NULL,
  `sortorderid` int(19) NOT NULL DEFAULT '0',
  `presence` int(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `vtiger_relatedlists` (
  ...
  `actions` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT '',
...
(98, 34, 13, 'get_related_list', 1, 'HelpDesk', 0, 'ADD,SELECT'),
(99, 34, 20, 'get_quotes', 2, 'Quotes', 0, 'ADD'),
(100, 34, 21, 'get_purchase_orders', 3, 'Purchase Order', 0, 'ADD'),
(101, 34, 22, 'get_salesorder', 4, 'Sales Order', 0, 'ADD'),
(102, 34, 23, 'get_invoices', 5, 'Invoice', 0, 'ADD'),
(103, 34, 19, 'get_service_pricebooks', 6, 'PriceBooks', 0, 'ADD'),
(104, 34, 7, 'get_related_list', 7, 'Leads', 0, 'SELECT'),
(105, 34, 6, 'get_related_list', 8, 'Accounts', 0, 'SELECT'),
(106, 34, 4, 'get_related_list', 9, 'Contacts', 0, 'SELECT'),
(107, 34, 2, 'get_related_list', 10, 'Potentials', 0, 'SELECT'),
(108, 34, 8, 'get_attachments', 11, 'Documents', 0, 'ADD,SELECT'),
(109, 13, 34, 'get_related_list', 6, 'Services', 0, 'SELECT'),
(110, 7, 34, 'get_related_list', 8, 'Services', 0, 'SELECT'),
(111, 6, 34, 'get_related_list', 16, 'Services', 0, 'SELECT'),
(112, 4, 34, 'get_related_list', 15, 'Services', 0, 'SELECT'),
(113, 2, 34, 'get_related_list', 9, 'Services', 0, 'SELECT'),
(114, 19, 34, 'get_pricebook_services', 3, 'Services', 0, 'SELECT'),
(121, 6, 45, 'get_dependents_list', 17, 'Projects', 0, 'add'),
(122, 4, 45, 'get_dependents_list', 16, 'Projects', 0, 'add'),
(123, 13, 45, 'get_related_list', 7, 'Projects', 0, 'SELECT'),
(124, 47, 6, 'get_related_list', 1, 'Accounts', 0, ' '),
(125, 47, 4, 'get_related_list', 2, 'Contacts', 0, ' '),
(126, 47, 7, 'get_related_list', 3, 'Leads', 0, ' '),
(127, 48, 13, 'get_related_list', 1, 'HelpDesk', 0, 'ADD,SELECT'),
(128, 48, 8, 'get_attachments', 2, 'Documents', 0, 'ADD,SELECT'),
(129, 6, 48, 'get_dependents_list', 18, 'Assets', 0, 'ADD'),
(130, 14, 48, 'get_dependents_list', 15, 'Assets', 0, 'ADD'),
(131, 23, 48, 'get_dependents_list', 5, 'Assets', 0, 'ADD'),
...
(138, 4, 48, 'get_dependents_list', 17, 'Assets', 0, 'ADD'),
...
CREATE TABLE IF NOT EXISTS `vtiger_relatedlists_rb` (
  ...
  `rel_table` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `rel_column` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `ref_column` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `related_crm_ids` text COLLATE utf8_bin
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_relcriteria` (
  ...
  `value` varchar(512) COLLATE utf8_bin DEFAULT NULL,
  `groupid` int(11) DEFAULT '1',
  `column_condition` varchar(256) COLLATE utf8_bin DEFAULT 'and',
...
CREATE TABLE IF NOT EXISTS `vtiger_relcriteria_grouping` (
  `groupid` int(11) NOT NULL,
  `queryid` int(19) NOT NULL,
  `group_condition` varchar(256) COLLATE utf8_bin DEFAULT NULL,
  `condition_expression` text COLLATE utf8_bin,
...
CREATE TABLE IF NOT EXISTS `vtiger_reminder_interval` (
  ...
  `reminder_interval` varchar(200) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_report` (
  ...
  `reportname` varchar(100) COLLATE utf8_bin DEFAULT '',
  `description` varchar(250) COLLATE utf8_bin DEFAULT '',
  `reporttype` varchar(50) COLLATE utf8_bin DEFAULT '',
  `queryid` int(19) NOT NULL DEFAULT '0',
  `state` varchar(50) COLLATE utf8_bin DEFAULT 'SAVED',
  `customizable` int(1) DEFAULT '1',
  `category` int(11) DEFAULT '1',
  `owner` int(11) DEFAULT '1',
  `sharingtype` varchar(200) COLLATE utf8_bin DEFAULT 'Private',
...
CREATE TABLE IF NOT EXISTS `vtiger_reportdatefilter` (
  ...
  `datecolumnname` varchar(250) COLLATE utf8_bin DEFAULT '',
  `datefilter` varchar(250) COLLATE utf8_bin DEFAULT '',
  `startdate` date DEFAULT NULL,
  `enddate` date DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_reportfolder` (
  `folderid` int(19) NOT NULL AUTO_INCREMENT,
  `foldername` varchar(100) COLLATE utf8_bin NOT NULL DEFAULT '',
  `description` varchar(250) COLLATE utf8_bin DEFAULT '',
  `state` varchar(50) COLLATE utf8_bin DEFAULT 'SAVED',
  PRIMARY KEY (`folderid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=13 ;
...
CREATE TABLE IF NOT EXISTS `vtiger_reportgroupbycolumn` (
  ...
  `sortcolname` varchar(250) COLLATE utf8_bin DEFAULT NULL,
  `dategroupbycriteria` varchar(250) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_reportmodules` (
  ...
  `primarymodule` varchar(50) COLLATE utf8_bin NOT NULL DEFAULT '',
  `secondarymodules` varchar(250) COLLATE utf8_bin DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `vtiger_reportsortcol` (
  ...
  `reportid` int(19) NOT NULL,
  `columnname` varchar(250) COLLATE utf8_bin DEFAULT '',
  `sortorder` varchar(250) COLLATE utf8_bin DEFAULT 'Asc',
...
CREATE TABLE IF NOT EXISTS `vtiger_reportsummary` (
  ...
  `columnname` varchar(250) COLLATE utf8_bin NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `vtiger_role` (
  ...
  `parentrole` varchar(255) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_rss` (
  ...
  `rssurl` varchar(200) COLLATE utf8_bin NOT NULL DEFAULT '',
  `rsstitle` varchar(200) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_salesorder` (
  ...
  `potentialid` int(19) DEFAULT NULL,
  `customerno` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `salesorder_no` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `quoteid` int(19) DEFAULT NULL,
  `vendorterms` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `contactid` int(19) DEFAULT NULL,
  `vendorid` int(19) DEFAULT NULL,
  `duedate` date DEFAULT NULL,
  `carrier` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `pending` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `type` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `adjustment` decimal(25,8) DEFAULT NULL,
  `salescommission` decimal(25,3) DEFAULT NULL,
  `exciseduty` decimal(25,3) DEFAULT NULL,
  ...
  `terms_conditions` text COLLATE utf8_bin,
  `purchaseorder` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `sostatus` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `currency_id` int(19) NOT NULL DEFAULT '1',
  `conversion_rate` decimal(10,3) NOT NULL DEFAULT '1.000',
...
CREATE TABLE IF NOT EXISTS `vtiger_salutationtype` (
  ...
  `salutationtype` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_scheduled_reports` (
  ...
  `recipients` text COLLATE utf8_bin,
  `schedule` text COLLATE utf8_bin,
...
CREATE TABLE IF NOT EXISTS `vtiger_settings_field` (
  ...
  `iconpath` varchar(300) COLLATE utf8_bin DEFAULT NULL,
  `description` text COLLATE utf8_bin,
  `linkto` text COLLATE utf8_bin,
  `sequence` int(19) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_sostatus` (
  ...
  `sostatus` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_systems` (
  ...
  `server_username` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `server_password` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `server_type` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `smtp_auth` varchar(5) COLLATE utf8_bin DEFAULT NULL,
  `server_path` varchar(256) COLLATE utf8_bin DEFAULT NULL,
  `from_email_field` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_tab` (
  ...
  `tablabel` varchar(25) COLLATE utf8_bin NOT NULL,
  ...
  `parent` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`tabid`),
...
(31, 'WSAPP', 0, -1, 'WSAPP', NULL, NULL, 1, 0, 0, 0, '3.4.4', ''),
...
(34, 'Services', 0, -1, 'Services', NULL, NULL, 0, 0, 1, 0, '2.6', 'Inventory'),
(35, 'MailManager', 0, -1, 'MailManager', NULL, NULL, 1, 0, 0, 0, '1.9', 'Tools'),
(36, 'Mobile', 0, -1, 'Mobile', NULL, NULL, 1, 0, 0, 0, '2.0', ''),
(37, 'Import', 0, -1, 'Import', NULL, NULL, 1, 0, 0, 0, '1.7', ''),
(38, 'EmailTemplates', 0, -1, 'Email Templates', NULL, NULL, 1, 0, 0, 0, '1.0', 'Tools'),
(39, 'Google', 0, -1, 'Google', NULL, NULL, 0, 0, 0, 0, '1.5', ''),
(40, 'ModComments', 0, -1, 'Comments', NULL, NULL, 0, 0, 1, 0, '2.1', 'Tools'),
(41, 'RecycleBin', 0, -1, 'Recycle Bin', NULL, NULL, 0, 0, 0, 0, '1.5', 'Tools'),
(42, 'CustomerPortal', 0, -1, 'CustomerPortal', NULL, NULL, 0, 0, 0, 0, '1.4', ''),
...
(46, 'Webforms', 0, -1, 'Webforms', NULL, NULL, 0, 0, 0, 0, '1.5', ''),
(47, 'SMSNotifier', 0, -1, 'SMSNotifier', NULL, NULL, 0, 0, 1, 0, '1.9', 'Tools'),
(48, 'Assets', 0, -1, 'Assets', NULL, NULL, 0, 0, 1, 0, '2.0', 'Inventory'),
...
CREATE TABLE IF NOT EXISTS `vtiger_tab_info` (
  `tabid` int(19) DEFAULT NULL,
  `prefname` varchar(256) COLLATE utf8_bin DEFAULT NULL,
  `prefvalue` varchar(256) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_taskpriority` (
  ...
  `taskpriority` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_taskstatus` (
  ...
  `taskstatus` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_taxclass` (
  ...
  `taxclass` varchar(200) COLLATE utf8_bin NOT NULL,
  `sortorderid` int(19) NOT NULL DEFAULT '0',
  `presence` int(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `vtiger_ticketcategories` (
  ...
  `ticketcategories` varchar(200) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_ticketcf` (
  `ticketid` int(19) NOT NULL DEFAULT '0',
  `from_portal` varchar(3) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_ticketcomments` (
  ...
  `ownertype` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `createdtime` datetime NOT NULL,
  PRIMARY KEY (`commentid`),
...
CREATE TABLE IF NOT EXISTS `vtiger_ticketpriorities` (
  ...
  `ticketpriorities` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `presence` int(1) NOT NULL DEFAULT '0',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_ticketseverities` (
  ...
  `ticketseverities` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `presence` int(1) NOT NULL DEFAULT '0',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_ticketstatus` (
  ...
  `ticketstatus` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `presence` int(1) NOT NULL DEFAULT '0',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_time_zone` (
  ...
  `time_zone` varchar(200) COLLATE utf8_bin NOT NULL,
  `sortorderid` int(19) NOT NULL DEFAULT '0',
  `presence` int(1) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `vtiger_tracker` (
  ...
  `module_name` varchar(25) COLLATE utf8_bin DEFAULT NULL,
  `item_id` varchar(36) COLLATE utf8_bin DEFAULT NULL,
  `item_summary` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `vtiger_usageunit` (
  ...
  `usageunit` varchar(200) COLLATE utf8_bin NOT NULL,
  `presence` int(1) NOT NULL DEFAULT '1',
  `picklist_valueid` int(19) NOT NULL DEFAULT '0',
  `sortorderid` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_name` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `user_password` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `user_hash` varchar(32) COLLATE utf8_bin DEFAULT NULL,
  `cal_color` varchar(25) COLLATE utf8_bin DEFAULT '#E6FAD8',
  `first_name` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `last_name` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `reports_to_id` varchar(36) COLLATE utf8_bin DEFAULT NULL,
  `is_admin` varchar(3) COLLATE utf8_bin DEFAULT '0',
  `currency_id` int(19) NOT NULL DEFAULT '1',
  `description` text COLLATE utf8_bin,
  `date_entered` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `date_modified` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `modified_user_id` varchar(36) COLLATE utf8_bin DEFAULT NULL,
  `title` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `department` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `phone_home` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `phone_mobile` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `phone_work` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `phone_other` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `phone_fax` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `email1` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `email2` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `secondaryemail` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `status` varchar(25) COLLATE utf8_bin DEFAULT NULL,
  `signature` text COLLATE utf8_bin,
  `address_street` varchar(150) COLLATE utf8_bin DEFAULT NULL,
  `address_city` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `address_state` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `address_country` varchar(25) COLLATE utf8_bin DEFAULT NULL,
  `address_postalcode` varchar(9) COLLATE utf8_bin DEFAULT NULL,
  `user_preferences` text COLLATE utf8_bin,
  `tz` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `holidays` varchar(60) COLLATE utf8_bin DEFAULT NULL,
  `namedays` varchar(60) COLLATE utf8_bin DEFAULT NULL,
  `workdays` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `weekstart` int(11) DEFAULT NULL,
  `date_format` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `hour_format` varchar(30) COLLATE utf8_bin DEFAULT 'am/pm',
  `start_hour` varchar(30) COLLATE utf8_bin DEFAULT '10:00',
  `end_hour` varchar(30) COLLATE utf8_bin DEFAULT '23:00',
  `activity_view` varchar(200) COLLATE utf8_bin DEFAULT 'Today',
  `lead_view` varchar(200) COLLATE utf8_bin DEFAULT 'Today',
  `imagename` varchar(250) COLLATE utf8_bin DEFAULT NULL,
  `deleted` int(1) NOT NULL DEFAULT '0',
  `confirm_password` varchar(300) COLLATE utf8_bin DEFAULT NULL,
  `internal_mailer` varchar(3) COLLATE utf8_bin NOT NULL DEFAULT '1',
  `reminder_interval` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `reminder_next_time` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `crypt_type` varchar(20) COLLATE utf8_bin NOT NULL DEFAULT 'MD5',
  `accesskey` varchar(36) COLLATE utf8_bin DEFAULT NULL,
  `theme` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `language` varchar(36) COLLATE utf8_bin DEFAULT NULL,
  `time_zone` varchar(200) COLLATE utf8_bin DEFAULT NULL,
  `currency_grouping_pattern` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `currency_decimal_separator` varchar(2) COLLATE utf8_bin DEFAULT NULL,
  `currency_grouping_separator` varchar(2) COLLATE utf8_bin DEFAULT NULL,
  `currency_symbol_placement` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `phone_crm_extension` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `no_of_currency_decimals` varchar(2) COLLATE utf8_bin DEFAULT NULL,
  `truncate_trailing_zeros` varchar(3) COLLATE utf8_bin DEFAULT NULL,
  `dayoftheweek` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `callduration` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `othereventduration` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `calendarsharedtype` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `default_record_view` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `leftpanelhide` varchar(3) COLLATE utf8_bin DEFAULT NULL,
  `rowheight` varchar(10) COLLATE utf8_bin DEFAULT NULL,
  `defaulteventstatus` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `defaultactivitytype` varchar(50) COLLATE utf8_bin DEFAULT NULL,
  `hidecompletedevents` int(11) DEFAULT NULL,
  `is_owner` varchar(5) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
...
(1, 'admin', '$1$ad000000$2zz9DYmeY.K1Yn9A/xAV41', 'd41d8cd98f00b204e9800998ecf8427e', '#E6FAD8', 'Admin', 'pwd: Abcd1234', '', 'on', 1, '', '2015-01-12 05:05:51', '0000-00-00 00:00:00', NULL, '', '', '', '', '', '', '', 'test@test.com', '', '', 'Active', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 'dd-mm-yyyy', '12', '00:00', '23:00', 'This Week', 'Today', '', 0, '$1$ad000000$nYTnfhTZRmUP.wQT9y1AE.', '1', '1 Minute', NULL, 'PHP5.3MD5', 'OHPtiWLDfqoEZKVl', 'alphagrey', 'en_us', 'Europe/Amsterdam', '123,456,789', '.', ',', '$1.0', '', '2', '1', 'Sunday', '5', '5', 'public', 'Summary', '0', 'medium', NULL, NULL, 0, '1');
...
CREATE TABLE IF NOT EXISTS `vtiger_users_last_import` (
  ...
  `assigned_user_id` varchar(36) COLLATE utf8_bin DEFAULT NULL,
  `bean_type` varchar(36) COLLATE utf8_bin DEFAULT NULL,
  `bean_id` varchar(36) COLLATE utf8_bin DEFAULT NULL,
  `deleted` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `vtiger_vendor` (
  ...
  `vendor_no` varchar(100) COLLATE utf8_bin NOT NULL,
  `vendorname` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  ...
  `state` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `pobox` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `postalcode` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `country` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `description` text COLLATE utf8_bin,
...
CREATE TABLE IF NOT EXISTS `vtiger_version` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `old_version` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  `current_version` varchar(30) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `vtiger_wordtemplates` (
  ...
  `date_entered` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `parent_type` varchar(50) COLLATE utf8_bin NOT NULL,
  `data` longblob,
  `description` text COLLATE utf8_bin,
  `filesize` varchar(50) COLLATE utf8_bin NOT NULL,
  `filetype` varchar(20) COLLATE utf8_bin NOT NULL,
  `deleted` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`templateid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(1, 'vtigerCRM', '54b355e0ac3ed', 'user');
...
CREATE TABLE IF NOT EXISTS `vtiger_ws_entity` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(25) COLLATE utf8_bin NOT NULL,
  `handler_path` varchar(255) COLLATE utf8_bin NOT NULL,
  `handler_class` varchar(64) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_ws_entity_fieldtype` (
  ...
  `fieldtype` varchar(200) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_ws_entity_name` (
  `entity_id` int(11) NOT NULL,
  `name_fields` varchar(50) COLLATE utf8_bin NOT NULL,
  `index_field` varchar(50) COLLATE utf8_bin NOT NULL,
  `table_name` varchar(50) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vtiger_ws_fieldinfo` (
  ...
  `property_name` varchar(32) COLLATE utf8_bin DEFAULT NULL,
  `property_value` varchar(64) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE IF NOT EXISTS `vtiger_ws_operation` (
  ...
  `handler_path` varchar(255) COLLATE utf8_bin NOT NULL,
  `handler_method` varchar(64) COLLATE utf8_bin NOT NULL,
